...
class TraceLogger {
    ...
    static func startTrace(tracer: TracerSdk, associatedObject: AnyObject, name: String, isRoot: Bool = false) {
    ...
    static func stopTrace(associatedObject: AnyObject, isRoot: Bool = false) {
